...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"lists.js":[function(require,module,exports) {
"use strict";
...
var MapArray = function MapArray(_ref) {
  var from = _ref.from,
      mapToProps = _ref.mapToProps,
      Child = _ref.children;
  return React.createElement(React.Fragment, null, from.map(function (item) {
    return React.createElement(Child, mapToProps(item));
  }));
};
...
var mapToProps = function mapToProps(_ref3) {
  var key = _ref3.id,
      done = _ref3.done,
      label = _ref3.title;
  return {
...
var TodoListAPp = function TodoListAPp(_ref4) {
  var items = _ref4.items;
  return React.createElement("ol", null, React.createElement(MapArray, {
    from: list,
    mapToProps: mapToProps
  }, TodoItem));
};

ReactDOM.render(React.createElement(TodoListAPp, {
  items: list
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","lists.js"], null)
//# sourceMappingURL=/lists.f3440fd0.map