...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"stateful-react.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  _inherits(LifeCycleTime, _React$Component);

  function LifeCycleTime(props) {
    var _this;

    _classCallCheck(this, LifeCycleTime);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(LifeCycleTime).call(this, props));
    _this.state = {
...
function (_React$Component2) {
  ...
  function App(props) {
    ...
    _this3.toggleColor = _this3.toggleColor.bind(_assertThisInitialized(_assertThisInitialized(_this3)));
    _this3.toggleUpdate = _this3.toggleUpdate.bind(_assertThisInitialized(_assertThisInitialized(_this3)));
    _this3.toggleUnmount = _this3.toggleUnmount.bind(_assertThisInitialized(_assertThisInitialized(_this3)));
    return _this3;
  }
  ...
  _createClass(App, [{
    ...
    value: function render() {
      var _this$state = this.state,
          ...
          dontUpdate = _this$state.dontUpdate,
          unmount = _this$state.unmount;
      return React.createElement(React.Fragment, null, unmount === false && React.createElement(LifeCycleTime, {
        color: color,
        dontUpdate: dontUpdate
      }), React.createElement("button", {
        onClick: this.toggleColor
      }, "Toggle color", JSON.stringify({
        color: color
      })), React.createElement("button", {
        onClick: this.toggleUpdate
      }, "Should update?", JSON.stringify({
        dontUpdate: dontUpdate
      })), React.createElement("button", {
        onClick: this.toggleUnmount
      }, "Should unmount?", JSON.stringify({
        unmount: unmount
      })));
    }
  }]);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","stateful-react.js"], null)
//# sourceMappingURL=/stateful-react.93087c1a.map